  ...
  return (
    <div className="bg-white w-full overflow-x-hidden">
      <section className="relative overflow-hidden bg-gradient-to-b from-white to-gray-50/80 px-6 md:px-10 py-16 md:py-20">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(233,30,140,0.10),transparent_45%),radial-gradient(circle_at_80%_30%,rgba(2,8,23,0.06),transparent_40%)]" />
        <div className="relative mx-auto max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          <div>
            <p className="inline-flex items-center rounded-full border border-gray-200 bg-white/70 px-3 py-1 text-xs font-semibold tracking-wide text-gray-700">
              TWIG Secure Instant PIN · ATM
            </p>
            <h1 className="mt-4 text-2xl md:text-4xl font-bold text-[#020817] leading-tight">
              Instant PIN Selection at the <span className="text-[#E91E8C]">ATM</span>
            </h1>
              ...
              <ul className="mt-4 space-y-3 text-sm text-gray-700">
                <li>
                  ...
                  <div className="text-gray-600">
                    Allow customers to securely select or reset their card PIN at any ATM, eliminating the need for branch
                    visits.
                  </div>
                </li>
                <li>
                  <span className="font-semibold text-gray-900">Improved Security</span>
                  <div className="text-gray-600">
                    Supports multi-factor verification such as OTP and biometric authentication before PIN creation.
                  </div>
                </li>
                <li>
                  <span className="font-semibold text-gray-900">Real-Time PIN Provisioning</span>
                  <div className="text-gray-600">
                ...
                <li>
                  <span className="font-semibold text-gray-900">Secure Infrastructure Integration</span>
                  <div className="text-gray-600">
      ...
      <section className="px-6 md:px-10 pb-20">
        <div className="mx-auto max-w-6xl rounded-3xl border border-gray-200 bg-gradient-to-r from-[#E91E8C] to-[#C41A78] p-10 text-white">
          ...
          <p className="mt-3 text-white/90 max-w-3xl">
            Contact SterlingPRO today to learn how TWIG Secure Instant PIN can enable seamless PIN selection across ATM,
            in-branch POS, and alternate channels.
          </p>
...
export default TwigSecureInstantPinAtm;
