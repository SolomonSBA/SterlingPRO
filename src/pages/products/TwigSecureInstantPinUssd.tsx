          ...
          >
            ...
            <div className="relative bg-white rounded-2xl border border-gray-200 shadow-xl p-6">
              ...
              <div className="mt-4 rounded-xl bg-gradient-to-br from-gray-50 to-white border border-gray-200 p-4 shadow-sm">
                <p className="inline-flex items-center rounded-full bg-[#E91E8C]/10 px-3 py-1 text-[11px] font-semibold uppercase tracking-wider text-[#C41A78]">Simple and Accessible PIN Services</p>
          ...
          <div className="lg:col-span-5">
            <div className="rounded-2xl border border-gray-200 bg-gradient-to-br from-white via-white to-gray-50 p-6 shadow-md">
              ...
              <ul className="mt-4 space-y-3 text-sm text-gray-700">
                <li className="flex gap-2"><span className="mt-1.5 h-2 w-2 rounded-full bg-[#E91E8C] flex-shrink-0" />Extends PIN services to customers using basic mobile phones</li>
                <li className="flex gap-2"><span className="mt-1.5 h-2 w-2 rounded-full bg-[#E91E8C] flex-shrink-0" />Enables PIN management without internet connectivity</li>
                <li className="flex gap-2"><span className="mt-1.5 h-2 w-2 rounded-full bg-[#E91E8C] flex-shrink-0" />Supports secure authentication before PIN entry</li>
                <li className="flex gap-2"><span className="mt-1.5 h-2 w-2 rounded-full bg-[#E91E8C] flex-shrink-0" />Reduces branch traffic for routine PIN changes</li>
                <li className="flex gap-2"><span className="mt-1.5 h-2 w-2 rounded-full bg-[#E91E8C] flex-shrink-0" />Ensures real-time integration with card management systems</li>
              </ul>
            </div>
          </div>
        </div>
